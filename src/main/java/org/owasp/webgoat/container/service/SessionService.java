...
public class SessionService {
  ...
  private final Messages messages;
   ...
   @RequestMapping(path = "/service/enable-security.mvc", produces = "application/json", method = RequestMethod.POST) // REQUIRES IMPORT: org.springframework.web.bind.annotation.RequestMethod
  @ResponseBody
