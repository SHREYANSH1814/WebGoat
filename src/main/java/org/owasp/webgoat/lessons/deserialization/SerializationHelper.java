...
private ObjectInputStream createValidatedObjectInputStream(byte[] data, byte[] expectedHmac) throws IOException, SecurityException {
    // Validate HMAC before deserialization to ensure data integrity and authenticity
    try {
        ...
        throw new SecurityException("Failed to validate HMAC", e);
    }
