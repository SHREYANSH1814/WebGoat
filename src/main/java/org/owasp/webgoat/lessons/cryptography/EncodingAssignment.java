  ...
  public String getBasicAuth(HttpServletRequest request) {
    ...
    if (basicAuth == null) {
      ...
      request.getSession().setAttribute("basicAuth", basicAuth);
          // Invalidate the session attribute after use to avoid mixing trusted and untrusted data
          // or consider storing only validated data and not mixing untrusted inputs directly
    }
