...
Path safeFileName = Paths.get((id == null ? String.valueOf(RandomUtils.nextInt(1, 11)) : String.valueOf(id)) + ".jpg").getFileName();
var catPicture = new File(catPicturesDirectory, safeFileName.toString());
