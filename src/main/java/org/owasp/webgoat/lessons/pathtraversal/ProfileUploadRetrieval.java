...
public class ProfileUploadRetrieval implements AssignmentEndpoint {
  ...
  public ResponseEntity<?> getProfilePicture(HttpServletRequest request) {
      ...
      try {
        String fileName = (id == null ? Integer.toString(RandomUtils.nextInt(1, 11)) : id) + ".jpg";
        File catPicture = new File(catPicturesDirectory, fileName);

        // Resolve canonical path and ensure it is within catPicturesDirectory
        String canonicalBasePath = catPicturesDirectory.getCanonicalPath();
        String canonicalFilePath = catPicture.getCanonicalPath();
